...
const NagpurRange: React.FC = () => {
  ...
  const data = [
    { sr: 1, commissionerate: { marathi: "पोलीस मध्यवर्ती मोटार परिवहन कर्मशाळा, नागपूर", english: "Police Central Motor Transport Workshop, Nagpur" }, officerName: { marathi: "-", english: "-" }, designation: { marathi: "पोलीस उप-अधीक्षक", english: "Deputy Superintendent of Police" }, contact: "" },
    ...
    { sr: 14, commissionerate: { marathi: "मो.प. विभाग, अकोला", english: "M.T. Akola" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    { sr: 15, commissionerate: { marathi: "मो.प. विभाग, रेल्वे नागपूर", english: "M.T. Railway Nagpur" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    { sr: 16, commissionerate: { marathi: "मो.प.स्पेशल अ‍ॅक्शन फोर्स, नागपूर", english: "M.T. Special Action Force, Nagpur" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    { sr: 17, commissionerate: { marathi: "मो.प.SRPF ग्रुप 4, नागपूर", english: "M.T.SRPF Group 4, Nagpur" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    { sr: 18, commissionerate: { marathi: "मो.प.SRPF ग्रुप 9, अमरावती", english: "M.T.SRPF Group 9, Amravati" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    { sr: 19, commissionerate: { marathi: "मो.प.SRPF ग्रुप 13, गडचिरोली", english: "M.T. SRPF Group 13, Gadchiroli" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    { sr: 20, commissionerate: { marathi: "मो.प.SRPF ग्रुप 15, गोंदिया", english: "M.T. SRPF Group 15, Gondia" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
    { sr: 21, commissionerate: { marathi: "मो.प.SRPF ग्रुप 17, चंद्रपूर", english: "M.T. SRPF Group 17, Chandrapur" }, officerName: { marathi: "", english: "-" }, designation: { marathi: "पोलीस निरीक्षक", english: "Police Inspector" }, contact: "" },
