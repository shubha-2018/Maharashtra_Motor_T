    ...
    <nav className="w-full border-b border-blue-900 sticky top-0 z-50 bg-gradient-to-r from-blue-900 to-blue-950 shadow-lg">
      ...
      <div className="mx-auto px-2 sm:px-4 lg:px-6">
        <div className="flex items-center h-20 md:h-28 gap-2">
          ...
          <div className="hidden lg:flex flex-1 justify-center items-center">
            {navigationItems.map((item) => (
              ...
              >
                ...
                {hoveredMenu === item.name && item.items && (
                  <div className="absolute left-0 top-full mt-1 w-64 bg-blue-50 border shadow-xl rounded-md z-50">
                    ...
                    {item.items.map((sub) => (
                      ...
                      >
                        ...
                        {hoveredSubmenu === sub.name && sub.items && (
                          <div className="absolute left-full top-0 w-56 bg-blue-50 border shadow-xl rounded-md z-50">
                            {sub.items.map((child) => (
                              <div
                                key={child.name}
                                className="px-4 py-2 hover:bg-white cursor-pointer"
          ...
          {/* MOBILE BUTTON (FIXED ONLY) */}
          <div className="lg:hidden ml-auto z-[9999]">
            <Button
              variant="ghost"
              size="icon"
              onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
      ...
      {/* ✅ MOBILE MENU FIXED (ONLY RESPONSIVE FIX) */}
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed top-20 left-0 w-full max-h-[calc(100vh-5rem)] overflow-y-auto bg-blue-950 text-white border-t border-blue-800 px-4 py-3 z-[9999]">
