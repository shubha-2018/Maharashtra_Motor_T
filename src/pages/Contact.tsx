...
//         <iframe
//   title="Police Wireless & Spl (बिनतारी आणि विशेष पोलीस ठाणे)"
...
export default function ContactUs() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-950 text-gray-900 dark:text-gray-100 px-6 py-12 sm:px-12 lg:px-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto space-y-12">
       ...
       <div className="relative rounded-3xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 group">
  ...
  <a
    ...
    className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-blue-600 text-white px-4 py-2 rounded-full shadow-lg text-sm font-semibold hover:bg-blue-700 transition-all duration-300"
  >
    📍 View Police Wireless & Spl on Google Maps
  </a>
</div>
