...
export default function AccessibilityPage() {
    ...
    const accessibilityFeatures = [
        ...
        {
            icon: <Music className="w-6 h-6 text-blue-600 dark:text-blue-500" />,
            titleKey: "accessibility.auditory.title",
            descriptionKey: "accessibility.auditory.description",
        },
        {
            icon: <MousePointer className="w-6 h-6 text-blue-600 dark:text-blue-500" />,
            titleKey: "accessibility.motor.title",
            descriptionKey: "accessibility.motor.description",
        },
        {
            icon: <Keyboard className="w-6 h-6 text-blue-600 dark:text-blue-500" />,
        ...
        {
            icon: <Accessibility className="w-6 h-6 text-blue-600 dark:text-blue-500" />,
            ...
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                <Card className="bg-white/30 border border-gray-200 backdrop-blur-md shadow-lg rounded-3xl dark:bg-gray-800/30 dark:border-gray-700">
                    <CardContent className="p-8">
                        <h3 className="text-2xl font-bold text-blue-700 mb-4 dark:text-blue-400">
                        ...
                        >
                            <CardContent className="p-8 space-y-4">
                                <div className="flex items-center gap-3">
                                    {item.icon}
                                    <h3 className="text-2xl md:text-3xl p-3 font-bold text-blue-700 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-500 dark:to-blue-700">
                                        {t(item.titleKey)}
                                    </h3>
                                </div>
                    ...
                    <CardContent className="p-8">
                        ...
                        <div className="space-y-2">
                            <p className="text-gray-800 dark:text-gray-200">
                                <strong className="text-blue-800 dark:text-blue-300">{t("accessibility.contact.email")}:</strong> pcit@mahapolice.gov.in
                            </p>
                            <p className="text-gray-800 dark:text-gray-200">
                                <strong className="text-blue-800 dark:text-blue-300">{t("accessibility.contact.phone")}:</strong> +91-20-2612-7300
                            </p>
                        </div>
                    </CardContent>
                </Card>
