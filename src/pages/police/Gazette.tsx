  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-950 text-gray-900 dark:text-gray-100 px-6 py-12 sm:px-12 lg:px-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        {/* Heading */}
        <h1 className="text-5xl p-3 md:text-6xl font-extrabold tracking-tight text-center bg-gradient-to-r from-blue-400 via-teal-400 to-violet-400 bg-clip-text text-transparent drop-shadow-lg dark:from-blue-500 dark:via-teal-500 dark:to-violet-500">
          {t("pubs.title")}
        </h1>
